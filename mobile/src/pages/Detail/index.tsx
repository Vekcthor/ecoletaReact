...
import { View, TouchableOpacity, Image, ScrollView, StyleSheet, Text, SafeAreaView, Linking } from 'react-native';
...
const Detail = () =>{
    ...
    function handlerContact(){
        Linking.openURL(`whatsapp://send?phone=${data.point.contact}&text=The Bangue is Crazy!`)
    }
