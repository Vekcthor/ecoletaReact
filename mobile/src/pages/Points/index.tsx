...
import { View, TouchableOpacity, Image, ScrollView, StyleSheet, Text, Alert } from 'react-native';
...
const Points = () =>{
    ...
    useEffect(() => {
        async function loadPosition(){
            ...
            if(status !== 'granted'){
                Alert.alert('Erro!', 'Precisamos de sua localização para mostrar os pontos de coleta próximos!');
                return;
            }
